			...
			<div className="w-3/4 p-8">
				...
				<Element name="carnatic-music" className="mt-8">
					...
					<div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-6 shadow-md my-8"> {/* Added wrapper */}
						<div className="flex flex-row">
							<div className="md:w-1/2 p-4">
								...
								<p className=" text-gray-600 dark:text-gray-300">I presented the culmination of over 13 years of persistence and dedication to Carnatic Music in my Arangetram (graduation) on September 16th, 2023. The performance consisted of close to three hours of technical vocal pieces (Varnams, Krithis, and Geethams). Accompanied by Umamahesh Iyer on violin and Naren Pullela on mridangam, I performed for a crowd of hundreds of music fans. After the performance, I was acclaimed by Vidushi Smt. Thanmayee Krishnamurthy, a renowned Carnatic Vocalist.
								</p>
							</div>
					...
					<div className="flex flex-row">
						...
						<div className="md:w-1/2 p-4">
							<h2 className="text-2xl font-semibold text-blue-500 dark:text-blue-400 p-2">Where it all started (2011)</h2>
							<p className=" text-gray-600 dark:text-gray-300">This was my first performance, at age four. I was terrified, and refused to sing. My teacher, Mrs. Deepa Bhat, was the one that pushed me to get on stage that day, and she's pushed me to the heights that I've gotten to in Carnatic Music today.
					...
					<div className="flex flex-row">
						<div className="md:w-1/2 p-4">
							<h2 className="text-2xl font-semibold text-blue-500 dark:text-blue-400 p-2">My First Competition (2014)</h2>
							<p className=" text-gray-600 dark:text-gray-300">I sang competitively for the first time at age 7 in the Tamil Sangam of Greater Washington's Tamil Music Festival. My mom picked out one of her favorite songs: Ayarpadi Maligayil, a beautiful song about Krishna. I ended up taking home first place!
							</p>
						</div>
						<div className="md:h-1/2 w-full md:w-1/2 p-12">
							<img
					...
					<div className="flex flex-row">
						...
						<div className="md:w-1/2 p-4">
							<h2 className="text-2xl font-semibold text-blue-500 dark:text-blue-400 p-2">Annual Recitals (2018)</h2>
							<p className=" text-gray-600 dark:text-gray-300">As part of our school tradition, I performed at annual recitals in front of dozens of parents and students. Our school operated on a batch model, where students were grouped by skill level, and I was consistently placed with highschoolers, despite barely being in middle school.
							</p>
						</div>
				...
				<h1 className="text-4xl font-bold text-blue-600 dark:text-blue-500">Music Production</h1>
